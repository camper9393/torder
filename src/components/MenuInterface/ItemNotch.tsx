...
function ItemNotch() {
  ...
  const checkoutItems: CheckOutItems[] = useAppSelector(
  ...
  return (
    <motion.div
      ...
      onClick={() => router.push(`${pathname}/checkout${tableQuery}`)}
    >
      <div className="flex items-center gap-3 rounded-full bg-white px-3 py-2 shadow-xl ring-1 ring-black/5">
        ...
        <div className="w-full text-xs">
          ...
          <p className="text-gray-500 line-clamp-1">{checkoutItems[0].title}</p>
        </div>
